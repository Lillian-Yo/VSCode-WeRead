...
export type WeReadLanguage = 'zh-CN' | 'zh-TW' | 'en';
...
function getLanguage(): WeReadLanguage {
  const value = vscode.workspace.getConfiguration('weread').get<WeReadLanguage>('language', 'zh-CN');
